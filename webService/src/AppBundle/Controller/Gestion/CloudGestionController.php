...
class CloudGestionController extends Controller
{
    /**
    ...
    {
      return $this->render("gestion/cloud/mainScreen.html.twig",[
        "pricesName"=>PRICES_NAME,
    ...
    public function createCloudInstance(Request $request){
      ...
      foreach (PRICES_NAME as $priceName) {
        $price = new Price();
        $price->setName($priceName);
        $price->setValue(0);
        $em->persist($price);
